...
<button class="button link_dentro"><a href="/dvs/editor_password.php" class="btn btn-warning" style="color:#fff;">CAMBIAR PASSWORD PARA ENTRAR A ESTE DASHBOARD</a</buttton>

<button class="button link_rojo"><a href="/panel_configuracion.php" class="btn btn-warning" style="color:#fff;">CONFIGURAR AMBE SERVER</a</buttton>
